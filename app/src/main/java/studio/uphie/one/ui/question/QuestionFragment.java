 ...
 */
public class QuestionFragment extends AbsModuleFragment {
    ...
    public void onPageSelected(int position) {
        ...
        if (adapter.getCount() == position + 1) {
            adapter.add(QuestionContentFragment.newInstance(position+2));
        }
    }
    ...
    public void refresh() {
        ...
        list.add(QuestionContentFragment.newInstance(1));
        list.add(QuestionContentFragment.newInstance(2));
